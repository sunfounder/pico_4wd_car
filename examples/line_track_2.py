...
set_motor_power = car.set_motor_power_
...
#         print(gs_data)
        if gs_data == [0, 0, 0]:
            if last_data == [1, 0, 0]:
                set_motor_power(-MOTOR_POWER, MOTOR_POWER, -MOTOR_POWER, MOTOR_POWER)
                car.set_light_off()
            ...
            if gs_data == [0, 1, 0]:
                ...
                set_motor_power(MOTOR_POWER, -MOTOR_POWER, MOTOR_POWER, -MOTOR_POWER)
#                 set_motor_power(MOTOR_POWER, 0, MOTOR_POWER, 0)
                car.set_light_off()
                car.set_light_bottom_left_color([50, 50, 0])
            elif gs_data == [1, 0, 0]:
                set_motor_power(-MOTOR_POWER, MOTOR_POWER, -MOTOR_POWER, MOTOR_POWER)
#                 set_motor_power(0, MOTOR_POWER, 0, MOTOR_POWER)
                car.set_light_off()
